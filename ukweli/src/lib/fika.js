...
export const FACILITY_TYPES = {
  ...
  faith:  { label: 'Faith-based', color: '#9D8CFF' },
...
export const FACILITIES_FALLBACK = [
  ...
  { id:'f-ms-mombasa', name:'Marie Stopes Kenya — Mombasa', county:'Mombasa', area:'Mombasa', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-kisumu', name:'Marie Stopes Kenya — Kisumu', county:'Kisumu', area:'Kisumu', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-nakuru', name:'Marie Stopes Kenya — Nakuru', county:'Nakuru', area:'Nakuru', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-eldoret', name:'Marie Stopes Kenya — Eldoret', county:'Uasin Gishu', area:'Eldoret', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-thika', name:'Marie Stopes Kenya — Thika', county:'Kiambu', area:'Thika', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-nyeri', name:'Marie Stopes Kenya — Nyeri', county:'Nyeri', area:'Nyeri', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-meru', name:'Marie Stopes Kenya — Meru', county:'Meru', area:'Meru', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-kakamega', name:'Marie Stopes Kenya — Kakamega', county:'Kakamega', area:'Kakamega', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-kisii', name:'Marie Stopes Kenya — Kisii', county:'Kisii', area:'Kisii', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-embu', name:'Marie Stopes Kenya — Embu', county:'Embu', area:'Embu', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-ms-machakos', name:'Marie Stopes Kenya — Machakos', county:'Machakos', area:'Machakos', kind:'ngo', services:['Family planning','Safe care','HIV testing','Counselling'], verified:true },
  { id:'f-fhok-nairobi', name:'Family Health Options Kenya (FHOK) — Nairobi', county:'Nairobi', area:'Nairobi', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-mombasa', name:'Family Health Options Kenya (FHOK) — Mombasa', county:'Mombasa', area:'Mombasa', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-kisumu', name:'Family Health Options Kenya (FHOK) — Kisumu', county:'Kisumu', area:'Kisumu', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-nakuru', name:'Family Health Options Kenya (FHOK) — Nakuru', county:'Nakuru', area:'Nakuru', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-eldoret', name:'Family Health Options Kenya (FHOK) — Eldoret', county:'Uasin Gishu', area:'Eldoret', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-thika', name:'Family Health Options Kenya (FHOK) — Thika', county:'Kiambu', area:'Thika', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-nyeri', name:'Family Health Options Kenya (FHOK) — Nyeri', county:'Nyeri', area:'Nyeri', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-kitale', name:'Family Health Options Kenya (FHOK) — Kitale', county:'Trans Nzoia', area:'Kitale', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-fhok-meru', name:'Family Health Options Kenya (FHOK) — Meru', county:'Meru', area:'Meru', kind:'ngo', services:['Family planning','Youth-friendly services','HIV testing','GBV support'], verified:true },
  { id:'f-lvct-nairobi', name:'LVCT Health (One2One youth line 1190) — Nairobi', county:'Nairobi', area:'Nairobi', kind:'ngo', services:['HIV testing','GBV support','Counselling','Youth services'], verified:true },
  { id:'f-lvct-mombasa', name:'LVCT Health — Mombasa', county:'Mombasa', area:'Mombasa', kind:'ngo', services:['HIV testing','GBV support','Counselling','Youth services'], verified:true },
  { id:'f-lvct-kisumu', name:'LVCT Health — Kisumu', county:'Kisumu', area:'Kisumu', kind:'ngo', services:['HIV testing','GBV support','Counselling','Youth services'], verified:true },
  { id:'f-faith-kijabe', name:'AIC Kijabe Hospital', county:'Kiambu', area:'Kijabe', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-kikuyu', name:'PCEA Kikuyu Hospital', county:'Kiambu', area:'Kikuyu', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-nazareth', name:'Nazareth Hospital', county:'Kiambu', area:'Riara Ridge', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-mater', name:'Mater Misericordiae Hospital', county:'Nairobi', area:'South B', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-stmary-nbo', name:'St. Mary’s Mission Hospital', county:'Nairobi', area:'Langata', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-consolata', name:'Consolata Hospital Mathari', county:'Nyeri', area:'Mathari', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-maua', name:'Maua Methodist Hospital', county:'Meru', area:'Maua', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-tenwek', name:'Tenwek Hospital (AIC)', county:'Bomet', area:'Tenwek', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-kendu', name:'Kendu Adventist Hospital', county:'Homa Bay', area:'Kendu Bay', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-mutomo', name:'Mutomo Mission Hospital', county:'Kitui', area:'Mutomo', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-faith-mumias', name:'St. Mary’s Mission Hospital, Mumias', county:'Kakamega', area:'Mumias', kind:'faith', services:['HIV testing','Antenatal care','Counselling','Maternal & child health'], verified:true },
  { id:'f-cso-zamara', name:'Zamara Foundation (youth SRHR)', county:'Nairobi', area:'Nairobi', kind:'ngo', services:['Information','Referrals','Peer support','Youth services'], verified:true },
  { id:'f-cso-rhnk', name:'Reproductive Health Network Kenya (RHNK)', county:'Nairobi', area:'Nairobi', kind:'ngo', services:['Information','Referrals','Peer support','Youth services'], verified:true },
  { id:'f-cso-dsw', name:'DSW Kenya — Youth-to-Youth', county:'Nairobi', area:'Nairobi', kind:'ngo', services:['Information','Referrals','Peer support','Youth services'], verified:true },
  { id:'f-cso-icl', name:'I Choose Life-Africa', county:'Nairobi', area:'Nairobi', kind:'ngo', services:['Information','Referrals','Peer support','Youth services'], verified:true },
]
